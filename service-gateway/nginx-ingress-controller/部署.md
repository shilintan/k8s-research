...
helm install nginx nginx-ingress-controller/ --namespace nginx --create-namespace -f values.yaml
helm upgrade nginx nginx-ingress-controller/ --namespace nginx --create-namespace -f values.yaml
